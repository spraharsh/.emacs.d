...
(custom-set-variables
 ...
 '(lsp-ui-sideline-diagnostic-max-lines 60)
...
(use-package lsp-mode
  :hook (((c-mode c++-mode latex-mode LaTeX-mode tex-mode bibtex-mode) . lsp)
...
;;   (face-remap-add-relative 'default :family "SF Mono" :height 90))
