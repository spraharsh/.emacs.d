...
(custom-set-variables
 ...
 '(org-publish-project-alist
   `
   (("default" :base-directory ,(file-name-as-directory
                                   (expand-file-name "~/website"))
     :base-extension "org" :publishing-directory
     ,(file-name-as-directory (expand-file-name "~/public_html")) :publishing-function
     ...
     "html" :body-only t)
    ("post" :base-directory ,(file-name-as-directory
                               (expand-file-name "~/website"))
     :base-extension "org" :publishing-directory
     ,(expand-file-name "_posts/" "~/public_html/")
     :publishing-function org-html-publish-to-html :headline-levels 4
     :section-numbers nil :with-toc nil :html-head
     "<link rel=\"stylesheet\" href=\"./css/style.css\" type=\"text/css\"/>"
     :html-preamble t :recursive t :make-index t :html-extension
     "html" :body-only t)
    ("images" :base-directory ,(expand-file-name "img/" "~/website/")
     :base-extension "jpg\\|gif\\|png" :publishing-directory
     ,(expand-file-name "img/" "~/public_html/") :publishing-function
     org-publish-attachment :recursive t)
    ("js" :base-directory ,(expand-file-name "js/" "~/website/")
     :base-extension "js" :publishing-directory
     ,(expand-file-name "js/" "~/public_html/") :publishing-function
     org-publish-attachment :recursive t)
    ("css" :base-directory ,(expand-file-name "css/" "~/website/")
     :base-extension "css\\|el" :publishing-directory
     ,(expand-file-name "css/" "~/public_html/") :publishing-function
     org-publish-attachment :recursive t)
 ...
 '(org2jekyll-source-directory (expand-file-name "~/website"))
 '(package-selected-packages
   '(4clojure ac-helm ac-math ac-rtags ace-jump-mode aggressive-indent
              all-the-icons-dired annotate anzu atom-one-dark-theme
              auctex-latexmk auctex-lua auto-complete-auctex
              auto-dim-other-buffers bind-chord ccls
              cherry-blossom-theme circe cmake-ide cmake-mode
              color-theme color-theme-sanityinc-tomorrow
              command-log-mode company-auctex company-box
              company-irony company-jedi company-lsp company-math
              company-posframe company-prescient company-reftex
              company-rtags company-tabnine cyberpunk-theme
              cython-mode d-mode dad-joke dap-mode dash-functional
              dashboard diminish dimmer dired+ dired-quick-sort
              disable-mouse doom-modeline doom-themes dracula-theme
              edit-server ein el-get eldoc-box elfeed-goodies
              elfeed-org elpy emacsql-sqlite emojify espresso-theme
              evil find-file-in-project fira-code-mode flatui-theme
              flycheck-cython flycheck-irony flycheck-julia
              flycheck-rtags font-lock+ forge function-args ggtags
              ghub+ gitattributes-mode gitignore-mode
              gmail-message-mode google-this goto-last-change
              goto-line-preview graphene graphql green-phosphor-theme
              gscholar-bibtex haskell-mode helm-bibtex helm-company
              helm-descbinds helm-lsp helm-projectile helm-rtags
              helm-swoop helm-tramp hide-mode-line
              highlight-indent-guides htmlize ido-ubiquitous json-mode
              json-reformat json-rpc jsonrpc julia-repl julia-snail
              jupyter kaolin-themes kv laas langtool
              latex-preview-pane leuven-theme logview look-mode
              lsp-grammarly lsp-haskell lsp-jedi lsp-julia lsp-latex
              ...
              sphinx-mode sublimity tree-sitter-langs
              treemacs-all-the-icons treemacs-icons-dired
              treemacs-magit treemacs-persp treemacs-projectile
              undo-tree unicode-escape vc-msg vimish-fold vterm
              which-key workgroups2 writeroom-mode xbm-life xkcd xref
