...
command's docstring;  But why, when there's `apropos-command'?" t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "workgroups2" '("aif" "awhen" "buffer-list" "wg-" "workgroups-mode")))
