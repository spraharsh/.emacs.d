;;; init-navigation.el --- Navigation tools -*- lexical-binding: t -*-

;;; Commentary:
;; Helm-swoop, avy, ace-jump, projectile, and navigation configuration.
...
(with-eval-after-load 'helm-swoop
  ;; Move between swoop variants and results.
